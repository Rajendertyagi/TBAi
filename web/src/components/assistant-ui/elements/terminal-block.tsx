 ...
 *
 * The ONLY adaptation: `CheckIcon`/`Loader2Icon` do not exist in the installed
 * lucide-react version, so they are aliased to `Check`/`Loader` here. No
 * styling, behavior, or API changes. Do NOT edit this file beyond that —
 * adapt around it in `web/src/tools/computer/terminal-ui.tsx`.
 */
