 ...
 * in a plain browser they are absent and the layout is unchanged. Must render
 * inside AssistantRuntimeProvider (sidebar thread list, tab titles, and all
 * views consume the ambient runtime).
 */
